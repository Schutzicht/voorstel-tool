...
// NOTE: when __PROPOSAL_ID is set (pretty URL serving), we DON'T
// replaceState — the ProposalViewer reads __PROPOSAL_ID directly and
// the address bar stays on the pretty URL.
try {
