  ...
  return (
    <div className="pdf-slide bg-[#FAF9F6] relative flex flex-col p-12 overflow-hidden">
      ...
      <div className="mb-6 relative z-10 reveal shrink-0">
        ...
        <h2 className="text-5xl font-display font-bold text-dark tracking-tight leading-none">Eenmalige investering.</h2>
      </div>
        ...
        <table className="w-full">
          <thead className="shrink-0">
            <tr className="bg-indigo text-white">
              <th className="text-left px-8 py-4 font-display font-bold text-xs uppercase tracking-widest">Onderdeel</th>
              <th className="text-right px-8 py-4 font-display font-bold text-xs uppercase tracking-widest">Prijs</th>
            </tr>
          </thead>
